...
const chainId = 31337;
const deployScript = "DeployAirdropGrowth.s.sol";
...
const contracts = [
  {
    name: "RewardToken",
    artifactFile: "RewardToken.sol",
    exportName: "rewardToken",
  },
  {
    name: "AirdropGrowthClaim",
    artifactFile: "AirdropGrowthClaim.sol",
    exportName: "airdropGrowthClaim",
  },
];
...
function generateMainContractsFile({
  ...
  lines.push(
    `export const airdropGrowthDeploymentMeta = ${JSON.stringify(
      deploymentMeta,
      null,
      2,
    )} as const;`,
...
function main() {
  ...
  console.log("Airdrop growth contracts synced.");
}
